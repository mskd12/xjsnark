...
public class AES128D extends CircuitGenerator {
  ...
  public AES128D() {
    ...
    this.__evaluateSampleRun(new SampleRun("Sample_Run1", true) {
      public void pre() {
        ...
        BigInteger msgV = new BigInteger("3ad77bb40d7a3660a89ecaf32466ef97", 16);
      ...
      public void post() {
        ...
        System.out.println();
        System.out.println("Expected Output: 6bc1bee22e409f96e93d7e117393172a");
      }
  ...
  private UnsignedInteger gal_mul_const(UnsignedInteger x, int c) {
    ...
    for (int counter = 0; counter < 8; counter += 1) {
      ...
      {
        Bit bit_l0c0nb = hi.copy();
        boolean c_l0c0nb = CircuitGenerator.__getActiveCircuitGenerator().__checkConstantState(bit_l0c0nb);
        if (c_l0c0nb) {
          if (bit_l0c0nb.getConstantValue()) {
            x.assign(tmp, 8);
          } else {
          ...
          ConditionalScopeTracker.push(bit_l0c0nb);
          x.assign(tmp, 8);
