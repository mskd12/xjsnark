...
public class Deco_GCM extends CircuitGenerator {
  ...
  public void __defineInputs() {
    ...
    plaintext = UnsignedInteger.createInputArray(this, plaintext.length, 8);
    key = UnsignedInteger.createInputArray(this, key.length, 8);
    counter = UnsignedInteger.createInputArray(this, counter.length, 8);
    initialCounter = UnsignedInteger.createInputArray(this, initialCounter.length, 8);
